...
const PatientDetailModal = ({handleOnClose,patient}) => {
  return (
    <div className='inset-0 z-50 bg-black backdrop-blur-sm bg-opacity-75 fixed flex justify-center items-center'>
        <div className='bg-white p-6 space-y-2 font-semibold text-lg text-black text-left'>
            <div className='text-right'><span className='p-1 bg-blue-500 rounded-full hover:bg-blue-600 hover:scale-105 cursor-pointer transition ease-in-out' onClick={handleOnClose}>X</span></div>
