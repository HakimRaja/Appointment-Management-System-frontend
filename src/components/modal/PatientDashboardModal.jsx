...
const PatientDashboardModal = ({doc,handleCloseModal,handleSelectButton,error,success,operation = 'Booking'}) => {
    ...
    <div className='fixed inset-0 flex justify-center items-center bg-black backdrop-blur-sm bg-opacity-75 z-50'>
        <div className='bg-white p-6 rounded-lg w-full max-w-md space-x-2 space-y-2'>
            <div className='text-right'><span className='bg-red-600 hover:bg-red-700 hover:scale-105 rounded-full transition ease-in-out cursor-pointer p-1 text-white' onClick={handleCloseModal}>X</span></div>
